                ...
                <div class="col-lg-3 col-md-6 col-sm-8 order-2 order-lg-1 produts-sidebar-filter">
                    <div class="filter-widget">
                        ...
                        foreach($result_all_cat as $key_all_cat){
                            ?>
                                <li><a href="#"><?php echo $key_all_cat['cat_name']; ?></a></li>
                        <?php 
                        }
...
?>    
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    <div class="pi-pic">
                                        <img src="dashboard/images/<?php echo $key_pro['image']; ?>" alt="">
                                    ...
                                    <?php if (isset($_SESSION['username'])){
                                        $i = $key_pro['id'];
                                        $s = $key_pro['stock'];
                                        echo '<a href="function/add_to_cart.php?id='.$i.'&stock='.$s.'" class="btn btn-primary>">Add To Cart</a>';
                                    }
                                    ?>
